...
# Research Objectives:
We pre-process the dataset and use the data to make predictions and derive insights. Using multiple factors like Physical activity, Sleep time, smoking, and BMI we can train a machine learning model on this dataset to predict a person's risk of developing heart disease considering the various factors present in the dataset. 
* What habits increase the risk of getting heart disease ?
* Using the various variables(habits) to predict a person's risk of developing heart disease.
